...
## 更新履歴
	...
	[追加要素]
	・難易度変更に対応
	MCBE側での難易度設定に応じて、追加敵モブのステータスが変動します。
	ドロップ等は変更ありません。従来通りの難易度で遊ぶ場合は「ノーマル」に設定してください。
	・ジエンドにフィールドボスの追加
	・ハードレザーシリーズの防具を精錬して鉄塊にするレシピを追加

	[調整・変更]
	・宝物樽の開封方法を変更
	行商人との取引で開封できます。
	・ネザージェリー、スライム(紫)が死亡後にも毒の判定が残る仕様を削除
	・竜巻の持続時間を減少。
	ジマルーツェの攻撃に伴う竜巻の持続時間も減少します。
	・行商人、研究者の取引内容を変更。
	・行商人、研究者、本屋が自然デスポーンしないように変更。
	...
	ver1.22.102
	[不具合修正]
	・クレバスバイオームにフィールドボスがスポーンしない不具合の修正
